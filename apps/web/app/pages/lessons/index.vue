<template>
  <section class="empty">
    <p class="empty__eyebrow">Lessons</p>
    <h1 class="empty__title">No lessons yet</h1>
    <p class="empty__copy">
      A simple list for this milestone. The full Smart Diary comes later —
      this page stays deliberately light.
    </p>
  </section>
</template>
