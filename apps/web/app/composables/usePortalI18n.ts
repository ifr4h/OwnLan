import portalEnGB from '~/locales/en-GB/portal'

type Dict = Record<string, unknown>

const locales: Record<string, Dict> = {
  'en-GB': portalEnGB as unknown as Dict,
}
...
/**
 * Learner portal i18n — en-GB today, structured for more locales later.
 */
export function usePortalI18n(locale = 'en-GB') {
